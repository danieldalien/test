...
<html>
  ...
  <head>
    <title>Delete Caracteristic</title>
  ...
  <body>
    ...
    <div class="main-block">
      ...
      <form action="../function/function_delete_cara.php" method="post" >
        <h1>Delete Caracteristic</h1>
            ...
            <select onchange="p_1(this);" required >
              ...
              $count = sizeof($cara_plantas) ;
                for($i = 0 ; $i < $count ; $i +=2 ){  
                  ...
                  echo ' 
                    <option value="['.$cara_plantas[$i][0].' , '.$cara_plantas[$i][1].']" > '.$cara_plantas[$i][1].'
                  ';
                }
              ?>
            </select>
